        ...
        <Dialog open={true} onClose={onClose} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel as={motion.div}
                    ...
                    className="w-full max-w-lg rounded-2xl bg-[#09090b] border border-white/10 p-8 shadow-2xl relative overflow-hidden"
                >
                    {/* Background accent */}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 relative">
                        ...
                        {/* Pro Plan */}
                        <div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5 relative ring-1 ring-amber-500/20">
